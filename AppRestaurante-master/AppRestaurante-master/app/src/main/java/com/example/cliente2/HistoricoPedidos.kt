...
class HistoricoPedidosActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        lifecycleScope.launch {
            ...
            mesaList = mesaDao.obterMesaFechada() // Exemplo de busca de todos os pedidos

            // Inicializando o Adapter com a lista de pedidos e os DAOs
            pedidoAdapter = PedidoAdapter(mesaList, pedidoDao, pedidoPratoDao, pratoDao, mesaDao, lifecycleScope)
